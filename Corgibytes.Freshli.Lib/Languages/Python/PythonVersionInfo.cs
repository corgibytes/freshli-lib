...
namespace Corgibytes.Freshli.Lib.Languages.Python
{
    public class PythonVersionInfo : IVersionInfo
    {
        ...
        */
        ...
        private int ProcessComparisons(List<Func<PythonVersionInfo, int>> comparisons, PythonVersionInfo otherVersionInfo)
        {
            var result = 0;
        ...
        private int CompareReleaseParts(PythonVersionInfo otherVersionInfo)
        {
            ...
            var countDifference = ReleaseParts.Count - otherVersionInfo.ReleaseParts.Count;
            ...
            {
                result = VersionHelper.CompareNumericValues(ReleaseParts[i], otherVersionInfo.ReleaseParts[i]);
                if (result != 0)
                {
                    break;
                }
        ...
        {
            return VersionHelper.CompareNumericValues((int)ReleaseSuffixType, (int)otherVersionInfo.ReleaseSuffixType);
        }

        private int CompareIfDevelopmentReleaseSuffixType(PythonVersionInfo otherVersionInfo)
        {
            return ReleaseSuffixType == SuffixType.Development ?
              VersionHelper.CompareNumericValues(DevelopmentRelease.Increment, otherVersionInfo.DevelopmentRelease.Increment) :
              0;
        }

        private int CompareIfPreReleaseSuffixType(PythonVersionInfo otherVersionInfo)
        {
        ...
        private int CompareIfPostReleaseSuffixType(PythonVersionInfo otherVersionInfo)
        {
        ...
        private int ComparePostReleaseIncrementIfPostSuffix(PythonVersionInfo otherVersionInfo)
        {
            ...
            int result = VersionHelper.CompareNumericValues(PostRelease.Increment, otherVersionInfo.PostRelease.Increment);
            return (result == 0) ?
                ComparePostReleaseVersions(otherVersionInfo) :
                result;
        }
        ...
        {
            return VersionHelper.CompareNumericValues((int)PreReleaseSuffixType, (int)otherVersionInfo.PreReleaseSuffixType);
        }

        private int ComparePreReleaseIncrement(PythonVersionInfo otherVersionInfo)
        {
            return VersionHelper.CompareNumericValues(PreRelease.Increment, otherVersionInfo.PreRelease.Increment);
        }

        private int ComparePreReleaseLabel(PythonVersionInfo otherVersionInfo)
        {
            var result = string.Compare(PreRelease.Label, otherVersionInfo.PreRelease.Label, StringComparison.InvariantCulture);
            return result;
        }
        ...
        private int CompareIfDevelopmentPostReleaseSuffixType(PythonVersionInfo otherVersionInfo)
        {
        ...
        private int ComparePostReleaseSuffixType(PythonVersionInfo otherVersionInfo)
        {
            return VersionHelper.CompareNumericValues((int)PostReleaseSuffixType, (int)otherVersionInfo.PostReleaseSuffixType);
        }

        private int ComparePostReleaseIncrement(PythonVersionInfo otherVersionInfo)
        {
            return VersionHelper.CompareNumericValues(PostRelease.Increment, otherVersionInfo.PostRelease.Increment);
        }
        ...
        private void ParseVersion()
        {
            ...
            ReleaseParts.AddRange(Conversions.SafeSplitIntoLongs(match.Groups[3].Value, '.'));

            PreRelease = BuildVersionPart(match.Groups[6].Value, match.Groups[7].Value, SuffixType.Pre);
            ...
            PostRelease = BuildVersionPart(match.Groups[9].Value, match.Groups[10].Value, SuffixType.Post);
            ...
            DevelopmentRelease = BuildVersionPart("dev", match.Groups[13].Value, SuffixType.Development);
        ...
        private PythonVersionPart BuildVersionPart(string label, string increment, SuffixType suffixType)
        {
        ...
        public void RemoveLastReleaseIncrement()
        {
            if (Release.Contains("."))
            {
                Version = Release = Release.Remove(Release.LastIndexOf(".", StringComparison.Ordinal));
                ReleaseSuffix = null;
            }
        }
